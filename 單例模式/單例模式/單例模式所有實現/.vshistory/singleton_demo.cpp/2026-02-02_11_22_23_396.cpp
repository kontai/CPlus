...
int main() {
    ...
    s1->showMessage();
    s2->showMessage();
    std::cout << "是否為同一實例: " << (s1 == s2)  << std::endl << std::endl;
    ...
    s3->showMessage();
    s4->showMessage();
    std::cout << "是否為同一實例: " << (s3 == s4)  << std::endl << std::endl;
    ...
    s5.showMessage();
    s6.showMessage();
    std::cout << "是否為同一實例: " << (&s5 == &s6) << std::endl << std::endl;
    ...
    s7.showMessage();
    s8.showMessage();
    std::cout << "是否為同一實例: " << (&s7 == &s8) << std::endl << std::endl;
    ...
    s9.showMessage();
    s10.showMessage();
    std::cout << "是否為同一實例: " << (&s9 == &s10) << std::endl << std::endl;
